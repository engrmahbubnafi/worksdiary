                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="text-center mb-1">
                            ...
                            <a class="btn btn-sm btn-primary me-2"
                                href="../../demo1/dist/apps/ecommerce/customers/listing.html">Try now</a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4 my-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">$72.00</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">$45.00</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">$168.00</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="ps-0">
                                            <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                                class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Yellow
                                                Stone</a>
                                            <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item:
                                                #XDG-2347</span>
                                        </td>
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header py-7">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Title-->
                                <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">0.37%</span>
                                <!--end::Title-->
                                <!--begin::Badge-->
                                <span class="badge badge-danger fs-base">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                            ...
                            <!--end::Heading-->
                            <!--begin::Description-->
                            <span class="fs-6 fw-bold text-gray-400">Online store convertion rate</span>
                            <!--end::Description-->
                        </div>
                        <!--end::Statistics-->
                        <!--begin::Toolbar-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-0">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-5">
                                    ...
                                    <div class="me-5">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="text-gray-800 fw-bolder text-hover-primary fs-6">Search
                                            Retargeting</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link
                                            clicks</span>
                                        <!--end::Desc-->
                                    </div>
                                    <!--end::Content-->
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Number-->
                                    <span class="text-gray-800 fw-bolder fs-6 me-3">0.24%</span>
                                    <!--end::Number-->
                                    <!--begin::Info-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Number-->
                                    <span class="text-gray-800 fw-bolder fs-6 me-3">0.94%</span>
                                    <!--end::Number-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-center">
                                        <!--begin::label-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Number-->
                                    <span class="text-gray-800 fw-bolder fs-6 me-3">1.23%</span>
                                    <!--end::Number-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-center">
                                        <!--begin::label-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-5">
                                    ...
                                    <div class="me-5">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="text-gray-800 fw-bolder text-hover-primary fs-6">Referrals
                                            Customers</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Number-->
                                    <span class="text-gray-800 fw-bolder fs-6 me-3">0.08%</span>
                                    <!--end::Number-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-center">
                                        <!--begin::label-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Number-->
                                    <span class="text-gray-800 fw-bolder fs-6 me-3">0.46%</span>
                                    <!--end::Number-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-center">
                                        <!--begin::label-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Brasil</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">All Social
                                        Channels</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Turkey</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">France</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Impact Radius
                                        visits</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">India</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Sweden</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
            ...
            <div class="col-xl-4 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header py-7">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">Social Network Visits</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">8k social visitors</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                    ...
                    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Linked
                                        In</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Facebook</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social
                                        Network</span>
            ...
            <div class="col-xl-4 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Departments</span>
                            <span class="text-gray-400 pt-2 fw-bold fs-6">Performance &amp; achievements</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                    ...
                    <div class="card-body d-flex align-items-end">
                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div
                                    ...
                                    <div class="me-5">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="text-gray-800 fw-bolder text-hover-primary fs-6">Direct Source</a>
                                        <!--end::Title-->
                                        <!--begin::Desc-->
                                        <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link
                                            clicks</span>
                            ...
                            <div class="text-center pt-8 d-1">
                                <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                    class="text-primary opacity-75-hover fs-6 fw-bolder">View Store Analytics
