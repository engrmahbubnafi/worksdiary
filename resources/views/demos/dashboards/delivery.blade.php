                    ...
                    <div class="card-header pt-7">
                        ...
                        <div class="card-toolbar">
                            <a href="#" class="btn btn-sm btn-light" data-bs-toggle='tooltip'
                                ...
                                title="Delivery App is coming soon">View All</a>
                        </div>
                        <!--end::Toolbar-->
                    </div>
                    <!--end::Header-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/14.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Fjallraven</a>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/13.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Nike AirMax</a>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/41.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Bose QC 35</a>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/53.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Greeny</a>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/71.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Apple Watches</a>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Icon-->
                                <img src="{{ asset('assets/media/stock/ecommerce/194.gif') }}" class="me-4 w-50px"
                                    alt="" />
                                <!--end::Icon-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Friendly Robot</a>
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                ...
                                                                Simmons</a>
                                                            <span class="text-muted fw-bold d-block fs-7">Zuid
                                                                Area</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block mb-1 fs-6">1,240</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block mb-1 fs-6">6,074</span>
                                                    <span class="fw-bold text-gray-400 d-block">Deliveries</span>
                                                </td>
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">$174,074</a>
                                                    <span class="text-muted fw-bold d-block fs-7">Earnings</span>
                                                </td>
                                                <td>
                                                    <div class="rating">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">$2,737</a>
                                                    <span class="text-muted fw-bold d-block fs-7">Earnings</span>
                                                </td>
                                                <td>
                                                    <div class="rating">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block mb-1 fs-6">2,954</span>
                                                    <span class="fw-bold text-gray-400 d-block">Deliveries</span>
                                                </td>
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">$59,634</a>
                                                    <span class="text-muted fw-bold d-block fs-7">Earnings</span>
                                                </td>
                                                <td>
                                                    <div class="rating">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">$19,842</a>
                                                    <span class="text-muted fw-bold d-block fs-7">Earnings</span>
                                                </td>
                                                <td>
                                                    <div class="rating">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="kt_list_widget_18_tab_content_1">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Abstergo
                                                Ltd.</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ asset('assets/media/svg/brand-logos/balloon.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Barone
                                                LLC.</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Big Kahuna
                                                Burger</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ asset('assets/media/svg/brand-logos/telegram-2.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Binford
                                                Ltd.</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Social
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div id="kt_charts_widget_17_chart" class="w-100 h-400px">
                            <div style="position: relative; height: 100%;">
                                <div style="position: absolute; width: 613px; height: 400px;">
                                    <div>
                                        <canvas width="613" height="400"
                                            style="position: absolute; top: 0px; left: 0px; width: 613px; height: 400px;">
                                        </canvas>
                                    </div>
                                </div>
                                <div role="alert"
                                ...
                                <div role="application"
                                    style="position: absolute; pointer-events: none; top: 0px; left: 0px; overflow: hidden; width: 613px; height: 400px;">
                                </div>
                                <div>
                                    <div role="tooltip"
                                        style="position: absolute; opacity: 1e-07; pointer-events: none;">One: 27.03%
                                    </div>
                                </div>
                            </div>
                        </div>
