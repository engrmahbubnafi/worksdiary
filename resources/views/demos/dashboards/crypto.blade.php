                ...
                <div class="row g-5 g-xl-10">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
                            ...
                            <div class="card-body text-center pt-5">
                                <!--begin::Image-->
                                <img src="{{ asset('assets/media/svg/shapes/bitcoin.svg') }}" class="h-125px mb-5"
                                    alt="" />
                                <!--end::Image-->
                                <!--begin::Section-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-flush h-xl-100" style="background-color: #F3D6EF">
                            ...
                            <div class="card-body text-center pt-5">
                                <!--begin::Image-->
                                <img src="{{ asset('assets/media/svg/shapes/ethereum.svg') }}" class="h-125px mb-5"
                                    alt="" />
                                <!--end::Image-->
                                <!--begin::Section-->
                                <div class="text-start">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-flush h-xl-100" style="background-color: #BFDDE3">
                            ...
                            <div class="card-body text-center pt-5">
                                <!--begin::Image-->
                                <img src="{{ asset('assets/media/svg/shapes/dogecoin.svg') }}" class="h-125px mb-5"
                                    alt="" />
                                <!--end::Image-->
                                <!--begin::Section-->
                                <div class="text-start">
                    ...
                    <div class="card-header position-relative min-h-50px p-0 border-bottom-2">
                        ...
                        <ul class="nav nav-pills nav-pills-custom d-flex position-relative w-100">
                            ...
                            <li class="nav-item mx-0 p-0 w-50">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-color-muted active border-0 h-100 px-0"
                                    data-bs-toggle="pill" id="kt_forms_widget_1_tab_1"
                            ...
                            <div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">
                                ...
                                <div class="form-floating border rounded mb-7">
                                    <select class="form-select form-select-transparent"
                                        ...
                                        <option></option>
                                        <option value="0"
                                            data-kt-select2-icon="{{ asset('assets/media/svg/coins/bitcoin.svg') }}"
                                            selected="selected">Bitcoin/BTC</option>
                                        <option value="1"
                                            data-kt-select2-icon="{{ asset('assets/media/svg/coins/ethereum.svg') }}">
                                            Ethereum/ETH</option>
                                        <option value="2"
                                            data-kt-select2-icon="{{ asset('assets/media/svg/coins/filecoin.svg') }}">
                                            Filecoin/FLE</option>
                                        <option value="3"
                                            data-kt-select2-icon="{{ asset('assets/media/svg/coins/chainlink.svg') }}">
                                            Chainlink/CIN</option>
                                        <option value="4"
                                            data-kt-select2-icon="{{ asset('assets/media/svg/coins/binance.svg') }}">
                                            Binance/BCN</option>
                                    </select>
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-floating">
                                            <input type="email" class="form-control text-gray-800 fw-bolder"
                                                placeholder="00.0" id="floatingInputValue" value="$230.00" />
                            ...
                            <div class="tab-pane fade" id="kt_forms_widget_1_tab_content_2">
                                ...
                                <div class="form-floating border rounded mb-7">
                                    <select class="form-select form-select-transparent"
                                        ...
                                        <option value="0"
                                            ...
                                            selected="selected">Bitcoin/BTC</option>
                                        <option value="1"
                                            data-kt-select2-icon="assets/media/svg/coins/ethereum.svg">Ethereum/ETH
                                        </option>
                                        <option value="2"
                                            data-kt-select2-icon="assets/media/svg/coins/filecoin.svg">Filecoin/FLE
                                        </option>
                                        <option value="3"
                                            data-kt-select2-icon="assets/media/svg/coins/chainlink.svg">Chainlink/CIN
                                        </option>
                                        <option value="4"
                                            data-kt-select2-icon="assets/media/svg/coins/binance.svg">Binance/BCN
                                        </option>
                                    </select>
                                    <label for="floatingInputValue">Coin Name</label>
                                </div>
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-floating">
                                            <input type="email" class="form-control text-gray-800 fw-bolder"
                                                placeholder="00.0" id="floatingInputValue" value="$0,0000005" />
                                            <label for="floatingInputValue">Amount(BTC)</label>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-floating">
                                            <input type="email" class="form-control text-gray-800 fw-bolder"
                                                placeholder="00.0" id="floatingInputValue" value="$1230.00" />
                                            <label for="floatingInputValue">Amount(USD)</label>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                ...
                <div class="card card-flush overflow-hidden h-xl-100">
                    ...
                    <div class="card-body d-flex justify-content-between flex-column pt-0 pb-1 px-0">
                        ...
                        <div class="px-9 mb-5">
                            ...
                            <!--end::Statistics-->
                            <!--begin::Description-->
                            <span class="fs-6 fw-bold text-gray-400">Transactions in April</span>
                            <!--end::Description-->
                        </div>
                        <!--end::Info-->
                        <!--begin::Chart-->
            ...
            <div class="col-xxl-4">
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            <!--begin::Title-->
                            <h1 class="fw-bold text-gray-800 text-center lh-lg">Try out our
                                <br />new
                        ...
                        <div class="text-center mb-1">
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_create_account"
                                data-bs-toggle="modal">Try Now</a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light"
                                href="../../demo1/dist/apps/ecommerce/sales/listing.html">Learn More</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                    </div>
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h4 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">Latest Activity</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-7">Updated 37 minutes ago</span>
                        </h4>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary mb-1 fs-6">Insurance</a>
                                            <span class="text-muted fw-bold d-block fs-7">Personal Health</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">BTC Wallet</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Personal Account</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">23 Jan, 22</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Last Payment</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">-0.0024 BTC</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Balance</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">ETH Wallet</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Personal Account</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">04 Feb, 22</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Last Payment</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">-0.346 ETH</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Balance</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">18 Feb, 22</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Last Payment</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">-0.00081 BTC</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Balance</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">DOGE Wallet</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Personal Account</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">01 Apr, 22</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Last Payment</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">-456.34 DOGE</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Balance</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">26 May, 22</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Last Payment</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-bolder d-block fs-6">-0.000039 BTC</span>
                                            <span class="text-gray-400 fw-bold d-block fs-7">Balance</span>
                                        </td>
                                        <td class="text-end">
                                            <a href="#"
            ...
            <div class="col-xxl-4">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-5">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-gray-800">Mining Status</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">GPUs
                                        mining</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="fw-bold fs-7 d-block text-start text-success ps-0">Running</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                            </div>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Est.
                                        daily USD</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#" class="text-gray-800 fw-bolder text-hover-primary fs-6">Team
                                        Members</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="fw-bold fs-7 d-block text-start text-gray-400 ps-0">6</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                            </div>
