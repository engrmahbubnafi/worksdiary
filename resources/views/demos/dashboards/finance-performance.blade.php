    ...
    <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Projects</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Stock Qty</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Stock Value</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">C APEX</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">OPEX</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="card h-lg-100">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                        ...
                        <div class="d-flex flex-column my-7">
                            ...
                            <!--begin::Follower-->
                            <div class="m-0">
                                <span class="fw-bold fs-6 text-gray-400">Saving</span>
                            </div>
                            <!--end::Follower-->
                        </div>
                        <!--end::Section-->
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-100 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Leading Companies</span>
                        ...
                        <div class="card-toolbar">
                            ...
                            <ul class="nav" id="kt_chart_widget_19_tabs">
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light active fw-bolder px-4 me-1"
                                        data-bs-toggle="tab" id="kt_chart_widget_19_tab_1"
                                        href="#kt_chart_widget_19_tab_content_1">2022</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4"
            ...
            <div class="col-xl-8 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-50 mb-5 mb-xl-10">
                    <!--begin::Header-->
            ...
            <div class="col-xxl-8">
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Some Chart with AmCharts</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">83 countries in service</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                            ...
                            <ul class="nav" id="kt_chart_widget_19_tabs">
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4 me-1"
                                        ...
                                        href="#kt_chart_widget_25_tab_content_1">2022</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light active fw-bolder px-4"
