            ...
            <div class="col-xxl-4 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Flag-->
                            <img src="{{ asset('assets/media/svg/brand-logos/youtube-3.svg') }}" class="me-4 w-30px"
                            ...
                            <table class="table table-row-dashed table-row-gray-300 gs-0 gy-4">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Buy phone
                                                online</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Top 10
                                                Earbuds</a>
                                        </td>
                                        <td class="d-flex align-items-center border-0">
                                            ...
                                            <div class="progress rounded-start-0">
                                                <div class="progress-bar bg-success m-0" role="progressbar"
                                                    style="height: 12px;width: 158px" aria-valuenow="158"
                                                    aria-valuemin="0" aria-valuemax="158px"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center border-0">
                                            ...
                                            <div class="progress rounded-start-0">
                                                <div class="progress-bar bg-success m-0" role="progressbar"
                                                    style="height: 12px;width: 129px" aria-valuenow="129"
                                                    aria-valuemin="0" aria-valuemax="129px"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">OLED TV in
                                                Amsterdam</a>
                                        </td>
                                        <td class="d-flex align-items-center border-0">
                                            <span class="fw-bolder text-gray-800 fs-6 me-3">263</span>
                                            <div class="progress rounded-start-0">
                                                <div class="progress-bar bg-success m-0" role="progressbar"
                                                    style="height: 12px;width: 112px" aria-valuenow="112"
                                                    aria-valuemin="0" aria-valuemax="112px"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center border-0">
                                            ...
                                            <div class="progress rounded-start-0">
                                                <div class="progress-bar bg-success m-0" role="progressbar"
                                                    style="height: 12px;width: 107px" aria-valuenow="107"
                                                    aria-valuemin="0" aria-valuemax="107px"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="#"
                                                class="text-gray-600 fw-bolder text-hover-primary mb-1 fs-6">Best noise
                                        ...
                                        <td class="d-flex align-items-center border-0">
                                            ...
                                            <div class="progress rounded-start-0">
                                                <div class="progress-bar bg-success m-0" role="progressbar"
                                                    style="height: 12px;width: 74px" aria-valuenow="74"
                                                    aria-valuemin="0" aria-valuemax="74px"></div>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
