<x-app-layout>
                        ...
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            ...
                            <div class="fs-4 text-white">
                                ...
                                <span class="position-relative d-inline-block">
                                    ...
                                    <!--begin::Separator-->
                                    <span
                                        class="position-absolute opacity-50 bottom-0 start-0 border-2 border-white border-bottom w-100"></span>
                                    <!--end::Separator-->
                                </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">37</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">6</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">4,7</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">822</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="{{ asset('assets/media/svg/brand-logos/vue-9.svg') }}"
                                    class="me-4 w-30px" alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <!--begin::Text-->
                                    <a href="#"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Vue 3</a>
                                    <!--end::Text-->
                                    <!--begin::Description-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    <!--begin::Text-->
                                    <a href="#"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Bootstrap 5</a>
                                    <!--end::Text-->
                                    <!--begin::Description-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    <!--begin::Text-->
                                    <a href="#"
                                        class="text-gray-800 text-hover-primary fs-5 fw-bolder lh-0">Angular 13</a>
                                    <!--end::Text-->
                                    <!--begin::Description-->
                                    <span class="text-gray-400 fw-bold d-block fs-6">JS Framework</span>
                                    <!--end::Description=-->
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/plugins/custom/vis-timeline/vis-timeline.bundle.j') }}s"></script>
