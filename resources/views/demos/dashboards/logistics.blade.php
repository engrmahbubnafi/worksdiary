                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 my-lg-12"
                                style="background-image:url('{{ asset('assets/media/svg/illustrations/easy/4.svg') }}')">
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Heading-->
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="d-flex flex-column content-justify-center flex-grow-1">
                                        ...
                                        <div class="d-flex fs-6 fw-bold align-items-center">
                                            ...
                                            <!--end::Bullet-->
                                            <!--begin::Label-->
                                            <div class="fs-6 fw-bold text-gray-400 flex-shrink-0">Used Plane freight
                                            </div>
                                            <!--end::Label-->
                                            <!--begin::Separator-->
                                            <div class="separator separator-dashed min-w-10px flex-grow-1 mx-2"></div>
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-sm-center mb-5">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <span
                                                class="badge badge-lg badge-light-success fw-bolder my-2">Delivered</span>
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                    <!--end::Wrapper-->
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-item align-items-center">
                                            ...
                                            <div class="timeline-content m-0">
                                                <!--begin::Title-->
                                                <span class="fs-6 text-gray-400 fw-bold d-block">Hektor Container
                                                    Hotel</span>
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-sm-center mb-5">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <span
                                                class="badge badge-lg badge-light-primary fw-bolder my-2">Shipping</span>
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                    <!--end::Wrapper-->
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-item align-items-center mb-7">
                                            ...
                                            <div class="timeline-content m-0">
                                                <!--begin::Title-->
                                                <span class="fs-6 text-gray-400 fw-bold d-block">Haven van
                                                    Rotterdam</span>
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-item align-items-center mb-7">
                                            ...
                                            <div class="timeline-content m-0">
                                                <!--begin::Title-->
                                                <span class="fs-6 text-gray-400 fw-bold d-block">Mina St - Zayed
                                                    Port</span>
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                        ...
                                        <div class="timeline-item align-items-center">
                                            ...
                                            <div class="timeline-content m-0">
                                                <!--begin::Title-->
                                                <span class="fs-6 text-gray-400 fw-bold d-block">27 Drydock
                                                    Boston</span>
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-sm-center mb-5">
                                        ...
                                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                            ...
                                            <span
                                                class="badge badge-lg badge-light-danger fw-bolder my-2">Delayed</span>
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                    <!--end::Wrapper-->
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-item align-items-center mb-7">
                                            ...
                                            <div class="timeline-content m-0">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                                <span class="fs-6 fw-bolder text-gray-800">Schipol Airport,
                                                    Amsterdam</span>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Timeline content-->
                                        ...
                                        <div class="timeline-item align-items-center">
                                            ...
                                            <div class="timeline-content m-0">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Title-->
                                                <span class="fs-6 fw-bolder text-gray-800">Changi Airport,
                                                    Singapore</span>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Timeline content-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">United
                                                States</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Ships</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Trucks</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">1,460
                                        Trucks</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Planes</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
                                    <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">8
                                        Aircrafts</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Content-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <div class="me-5">
                                    <!--begin::Title-->
                                    <a href="#"
                                        class="text-gray-800 fw-bolder text-hover-primary fs-6">Trains</a>
                                    <!--end::Title-->
                                    <!--begin::Desc-->
