    ...
    <x-slot name="subheader">
        <x-subheader-comp>
            ...
            <x-slot name="actions">
                ...
                <a href="../../demo1/dist/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">Manage
                    Sales</a>
                ...
                <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <!--end::Info-->
                            <!--begin::Subtitle-->
                            <span class="text-gray-400 pt-1 fw-bold fs-6">Average Daily
                                Sales</span>
                            <!--end::Subtitle-->
                        </div>
                        <!--end::Title-->
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                        ...
                        <div class="px-9 mb-5">
                            ...
                            <!--end::Statistics-->
                            <!--begin::Description-->
                            <span class="fs-6 fw-bold text-gray-400">Another $48,346 to
                                Goal</span>
                            <!--end::Description-->
                        </div>
                        <!--end::Statistics-->
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                        ...
                                        <thead>
                                            <tr class="fs-7 fw-bolder text-gray-500 border-bottom-0">
                                                ...
                                                <th class="pe-0 text-end min-w-120px">TOTAL PRICE
                                                </th>
                                            </tr>
                                        </thead>
                                        <!--end::Table head-->
            ...
            <div class="col-xl-6 mb-5 mb-xl-10">
                ...
                <div class="card card-flush overflow-hidden h-md-100">
                    ...
                    <div class="card-header py-5">
                        <!--begin::Title-->
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder text-dark">Discounted Product
                                Sales</span>
                            <span class="text-gray-400 mt-1 fw-bold fs-6">Users from all
                                channels</span>
                        </h3>
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="text-center mb-1">
                            ...
                            <a class="btn btn-sm btn-primary me-2"
                                href="../../demo1/dist/apps/ecommerce/sales/listing.html">View
                                App</a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light"
                                href="../../demo1/dist/apps/ecommerce/catalog/add-product.html">New
                                Product</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-bold fs-6">Avg. 57 orders per
                                day</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Actions-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-gray-400 mt-1 fw-bold fs-6">1M Products Shipped so
                                far</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
