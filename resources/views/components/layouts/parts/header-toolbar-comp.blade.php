        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px py-4"
                ...
                <div class="menu-item px-5">
                    <a href="{{ route('companies.users.show', [auth()->user()->company_id, auth()->user()->id]) }}"
                ...
                <div class="menu-item">
                    <div class="menu-content">
                        <label
                            class="form-check form-switch form-check-custom form-check-solid pulse pulse-success text-center">
