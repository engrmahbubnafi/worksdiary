<div class="d-flex align-items-stretch flex-shrink-0">
    <!--begin::Search-->
    @if (Layout::getConfig('toolbar.search'))
                        ...
                        <div class="mb-5" data-kt-search-element="main">
                            ...
                            <div class="scroll-y mh-200px mh-lg-325px">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="fs-6 text-hover-primary fw-bold text-gray-800">BoomApp
                                            by Keenthemes</a>
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">"Kept
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">"KPI
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="fs-6 text-hover-primary fw-bold text-gray-800">"FitPro
                                            App Development</a>
                                        <span class="fs-7 text-muted fw-bold">#84250</span>
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="#" class="fs-6 text-hover-primary fw-bold text-gray-800">Shopix
                                            Mobile App</a>
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="fs-6 text-hover-primary fw-bold text-gray-800">"Landing
                                            UI Design" Launch</a>
                    ...
                    <form data-kt-search-element="preferences" class="d-none pt-1">
                        ...
                        <div class="border-bottom pb-4">
                            <label
                                ...
                                <span class="form-check-label fs-6 fw-bold ms-0 me-2 text-gray-700">Projects</span>
                        ...
                        <div class="border-bottom py-4">
                            <label
                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label fs-6 fw-bold ms-0 me-2 text-gray-700">Targets</span>
                                <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                            </label>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="border-bottom py-4">
                            <label
                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label fs-6 fw-bold ms-0 me-2 text-gray-700">Affiliate
                                    Programs</span>
                        ...
                        <div class="border-bottom py-4">
                            <label
                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label fs-6 fw-bold ms-0 me-2 text-gray-700">Referrals</span>
                                <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                            </label>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="border-bottom py-4">
                            <label
                                class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label fs-6 fw-bold ms-0 me-2 text-gray-700">Users</span>
                                <input class="form-check-input" type="checkbox" value="1" />
                            </label>
                        </div>
                        <!--end::Input group-->
    ...
    <!--begin::Activities-->
    @if (Layout::getConfig('toolbar.activities'))
    ...
    <!--begin::Notifications-->
    @if (Layout::getConfig('toolbar.notifications'))
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            <!--begin::Menu- wrapper-->
            <div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px"
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                ...
                <div class="d-flex flex-column bgi-no-repeat rounded-top"
                    ...
                    <!--begin::Title-->
                    <h3 class="fw-bold mt-10 mb-6 px-9 text-white">Notifications
                        <span class="fs-8 ps-3 opacity-75">24 reports</span>
                    </h3>
                    <!--end::Title-->
                    <!--begin::Tabs-->
                    <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-bold px-9">
                        @if (Layout::getConfig('notifications.alert_tab'))
                            <li class="nav-item">
                        ...
                        @if (Layout::getConfig('notifications.upgrade_tab'))
                            <li class="nav-item">
                        ...
                        @if (Layout::getConfig('notifications.logs_tab'))
                            <li class="nav-item">
                                <a class="nav-link opacity-state-100 pb-4 text-white opacity-75" data-bs-toggle="tab"
                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Project
                                                Alice</a>
                                            <div class="fs-7 text-gray-400">Phase 1 development
                                            </div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">HR
                                                Confidential</a>
                                            <div class="fs-7 text-gray-400">Confidential staff
                                                documents</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Company
                                                HR</a>
                                            <div class="fs-7 text-gray-400">Corporeate staff
                                                profiles</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Project
                                                Redux</a>
                                            <div class="fs-7 text-gray-400">New frontend admin
                                                theme</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Project
                                                Breafing</a>
                                            <div class="fs-7 text-gray-400">Product launch status
                                                update</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Banner
                                                Assets</a>
                                            <div class="fs-7 text-gray-400">Collection of banner
                                                images</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-2 mb-0">
                                            <a href="#"
                                                class="fs-6 text-hover-primary fw-bolder text-gray-800">Icon
                                                Assets</a>
                                            <div class="fs-7 text-gray-400">Collection of SVG
                                                icons</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                        ...
                        <div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="pt-10 pb-0">
                                    <!--begin::Title-->
                                    <h3 class="text-dark fw-bolder text-center">Get Pro Access
                                    </h3>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-bold pt-1 text-center text-gray-600">Outlines
                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">New
                                            order</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Payment
                                            process</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Search
                                            query</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">API
                                            connection</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Database
                                            restore</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">System
                                            update</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Server
                                            OS update</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Refund
                                            process</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Withdrawal
                                            process</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <!--end::Code-->
                                        <!--begin::Title-->
                                        <a href="#" class="text-hover-primary fw-bold text-gray-800">Mail
                                            tasks</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
    ...
    <!--begin::Chat-->
    @if (Layout::getConfig('toolbar.chat'))
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            <!--begin::Menu wrapper-->
    ...
    <!--begin::Quick links-->
    @if (Layout::getConfig('toolbar.quick_links'))
        <div class="d-flex align-items-center ms-1 ms-lg-3">
            <!--begin::Menu wrapper-->
            <div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px"
                data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                ...
                <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                    style="background-image:url('{{ asset('assets/media/misc/pattern-1.jpg') }}')">
                    <!--begin::Title-->
                    <h3 class="fw-bold mb-3 text-white">Quick Links</h3>
                    <!--end::Title-->
                    <!--begin::Status-->
                ...
                <div class="row g-0">
                    ...
                    <div class="col-6">
                        <a href="../../demo1/dist/apps/projects/budget.html"
                            class="d-flex flex-column flex-center h-100 bg-hover-light border-end border-bottom p-6">
                            ...
                            <!--end::Svg Icon-->
                            <span class="fs-5 fw-bold mb-0 text-gray-800">Accounting</span>
                    ...
                    <div class="col-6">
                        <a href="../../demo1/dist/apps/projects/settings.html"
                            class="d-flex flex-column flex-center h-100 bg-hover-light border-bottom p-6">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com010.svg-->
                            <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                            ...
                            <!--end::Svg Icon-->
                            <span class="fs-5 fw-bold mb-0 text-gray-800">Administration</span>
                    ...
                    <div class="col-6">
                        <a href="../../demo1/dist/apps/projects/list.html"
                            class="d-flex flex-column flex-center h-100 bg-hover-light border-end p-6">
                            ...
                            <!--end::Svg Icon-->
                            <span class="fs-5 fw-bold mb-0 text-gray-800">Projects</span>
                    ...
                    <div class="col-6">
                        <a href="../../demo1/dist/apps/projects/users.html"
                            class="d-flex flex-column flex-center h-100 bg-hover-light p-6">
                            <!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
                            <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                            ...
                            <!--end::Svg Icon-->
                            <span class="fs-5 fw-bold mb-0 text-gray-800">Customers</span>
    ...
    <!--begin::Theme mode-->
    @if (Layout::getConfig('toolbar.theme_mode'))
        <div class="d-flex align-items-center ms-1 ms-lg-3">
    ...
    <!--begin::User menu-->
    @if (Layout::getConfig('toolbar.user_menu'))
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            <!--begin::Menu wrapper-->
            <div class="symbol symbol-30px symbol-md-40px cursor-pointer" data-kt-menu-trigger="click"
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px py-4"
                    ...
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column">
                            <div class="fw-bolder d-flex align-items-center fs-5">
                                <span class="badge badge-light-success fw-bolder fs-8 ms-2 px-2 py-1">Pro</span>
                            </div>
                            <a href="#"
                ...
                <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                    ...
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="../../demo1/dist/account/settings.html" class="menu-link d-flex active px-5">
                ...
                <div class="menu-item px-5">
                    <div class="menu-content px-5">
                        <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success"
                            ...
                            <span class="form-check-label fs-7 text-gray-600">Dark Mode</span>
                        </label>
                    </div>
                </div>
                <!--end::Menu item-->
