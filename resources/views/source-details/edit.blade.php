<x-app-layout>
    ...
    <x-slot name="subheader">
        <x-subheader-comp>
            ...
            @slot('actions')
                {!! Html::decode(
                    link_to_route('sources.source-details.index', 'Source Details', $source, ['class' => 'btn btn-sm btn-light']),
                ) !!}
            @endslot
        </x-subheader-comp>
    </x-slot>
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-body p-lg-15">
                ...
                {{ Form::model($sourceDetail, [
                    'route' => ['sources.source-details.update', [$source, $sourceDetail]],
                    'class' => 'form',
                    'method' => 'PUT',
                ]) }}
