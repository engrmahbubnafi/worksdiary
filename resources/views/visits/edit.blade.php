    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            ...
            <div class="card-body p-lg-15" x-data="createVisit" x-init="select2Alpine">
                ...
                {{ Form::model($visit, [
                    'route' => ['companies.visits.update', [$companyId, $visit->id]],
                    'class' => 'form',
                    'method' => 'PUT',
                ]) }}
                ...
                <div class="row g-9 mb-8">
                    <div class="col-md-6 fv-row">
                        {{ Form::label('visit_note', 'Visit Note', [
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('createVisit', () => ({
                    init() {
                        ...
                        @if (old('zone_id') || $visit->zone_id)

                            this.zoneId = @json(old('zone_id') ?? $visit->zone_id);
                    ...
                    zoneId: @json($visit->zone_id),
                    oldAssignTo: @json($visit->assign_to),
                    oldCompanyUnitId: @json($visit->company_unit_id),
                    oldUnitTypeId: @json($visit->unit_type_id),
                    assignTo: 0,
                    companyUnitId: 0,
                    companyId: 0,
                    unitTypeId: 0,
